...
var gauges = (function () {
    'use strict';
    var strings = LANG.PL,         //Set to your default language. Store all the strings in one object
        config = {
        ...
        //Gauge global look'n'feel settings LISTA STYLI http://wiki.sandaysoft.com/a/SteelSeries_FAQ#Setting_frame_design
        gaugeGlobals = {
            minMaxArea             : 'rgba(255,255,255,0.5)', //area sector for today's max/min. (red, green, blue, transparency)
            windAvgArea            : 'rgba(15,53,90,0.3)',
            windVariationSector    : 'rgba(15,53,90,0.3)', //only used when rose data is shown on direction gauge 
            ...
            pointerColour          : steelseries.ColorDef.ORANGE,
            dirAvgPointer          : steelseries.PointerType.TYPE2,
            dirAvgPointerColour    : steelseries.ColorDef.RED,
            gaugeType              : steelseries.GaugeType.TYPE4,
            lcdColour              : steelseries.LcdColor.BLACK,
            ...
            shadowColour           : 'rgba(0,0,0,0.2)'  //Colour to use for gauge shadows - default 30% transparent black
        },
        ...
        singleHum = (function () {
            ...
            function init() {
                ...
                if ($('#canvas_hum').length) {
                    ...
                    params.section = [steelseries.Section(0, 20, 'rgba(15, 53, 90, 0.2)'),
                                      steelseries.Section(20, 80, 'rgba(15, 53, 90, 0.4)'),
                                      steelseries.Section(80, 100, 'rgba(15, 53, 90, 0.6)')];
                    params.area = cache.areas;
                    params.maxValue = 100;
                    params.thresholdVisible = false;
                    params.titleString = cache.title;
                        ...
                        if (roseMax > 0) {
                            ...
                            for (i = 0; i < rosePoints; i++) {
                                roseAreas[i] = steelseries.Section(
                                    ...
                                    'rgba(' + gradient('003366', 'cc0033', data.WindRoseData[i] / roseMax) + ',' + (data.WindRoseData[i] / roseMax).toFixed(2) + ')'
                                );
                            }
                        }
        ...
        processData = function (dataObj) {
            ...
            if (data.ver !== undefined && data.ver >= _realtimeVer) {
                ...
                if (now - _sampleDate > config.stationTimeout * 60 * 1000) {
                    ...
                    ledIndicator.setLedColor(steelseries.LedColor.ORANGE_LED);
                    ...
                    ledIndicator.setLedColor(steelseries.LedColor.BLUE_LED);
        ...
        createTempSections = function (celsius) {
            ...
            if (celsius) {
                section = [
				 steelseries.Section(-100, -100, 'rgba(0,  0, 0, 0)'),
				
                    steelseries.Section(-100, -35, 'rgba(15, 53, 90, 0.8)'),
                    steelseries.Section(-35,  -30, 'rgba(15, 53, 90, 0.7)'),
                    steelseries.Section(-30,  -25, 'rgba(15, 53, 90, 0.6)'),
                    steelseries.Section(-25,  -20, 'rgba(15, 53, 90, 0.5)'),
                    steelseries.Section(-20,  -15, 'rgba(15, 53, 90, 0.4)'),
                    steelseries.Section(-15,  -10, 'rgba(15, 53, 90, 0.3)'),
                    steelseries.Section(-10,   -5, 'rgba(15, 53, 90, 0.2)'),
                    steelseries.Section(-5,     0, 'rgba(15, 53, 90, 0.1)'),
                    steelseries.Section(0,      5, 'rgba(  0, 0, 0, 0)'),
                    steelseries.Section(5,     10, 'rgba(204, 89, 30, 0.1)'),
                    steelseries.Section(10,    15, 'rgba(204, 89, 30, 0.15)'),
                    steelseries.Section(15,    20, 'rgba(204, 89, 30, 0.2)'),
                    steelseries.Section(20,    25, 'rgba(204, 89, 30, 0.25)'),
                    steelseries.Section(25,    30, 'rgba(204, 89, 30, 0.3)'),
                    steelseries.Section(30,    40, 'rgba(204, 89, 30, 0.35)'),
                    steelseries.Section(40,   100, 'rgba(204, 89, 30, 0.4)')
					
                ];
            } else {
                section = [
				 steelseries.Section(-200, -200, 'rgba(0,  0, 0, 0)'),
				 /*
        ...
        */
        createRainRateSections = function (metric) {
            ...
            if (metric) {
                ...
                section = [ steelseries.Section(0, 0.25, 'rgba(15, 53, 90, 0)'),
                           steelseries.Section(0.25, 1, 'rgba(15, 53, 90, 0.1)'),
                          steelseries.Section(1, 4, 'rgba(15, 53, 90, 0.2)'),
                          steelseries.Section(4, 16, 'rgba(15, 53, 90, 0.4)'),
                          steelseries.Section(16, 50, 'rgba(15, 53, 90, 0.6)'),
                          steelseries.Section(50, 1000, 'rgba(15, 53, 90, 0.8)')];
					
            } else {
                section = [ steelseries.Section(0, 0.05, 'rgba(15, 53, 90, 0)'),
                          steelseries.Section(0.05, 0.1, 'rgba(15, 53, 90, 0.1)'),
                         steelseries.Section(0.1, 0.15, 'rgba(15, 53, 90, 0.2)'),
                         steelseries.Section(0.15, 0.6, 'rgba(15, 53, 90, 0.4)'),
                           steelseries.Section(0.6, 2, 'rgba(15, 53, 90, 0.6)'),
                          steelseries.Section(2, 100, 'rgba(15, 53, 90, 0.8)')];
            }
        ...
        createRainfallSections = function (metric) {
            var section;
            if (metric) {
                section = [ steelseries.Section(0, 5, 'rgba(0, 0, 0, 0)'),
                            steelseries.Section(5, 10, 'rgba(0, 0, 0, 0)'),
                            steelseries.Section(10, 25, 'rgba(0, 0, 0, 0)'),
                            steelseries.Section(25, 40, 'rgba(0, 0, 0, 0)'),
                            steelseries.Section(40, 50, 'rgba(0, 0, 0, 0)'),
                            steelseries.Section(50, 65, 'rgba(0, 0, 0, 0)'),
                            steelseries.Section(65, 75, 'rgba(0, 0, 0, 0)'),
                            steelseries.Section(75, 100, 'rgba(0, 0, 0, 0)'),
                            steelseries.Section(100, 125, 'rgba(0, 0, 0, 0)'),
                            steelseries.Section(125, 500, 'rgba(0, 0, 0, 0)')];
            } else {
                section = [ steelseries.Section(0, 0.2, 'rgba(0, 0, 0, 0)'),
                            steelseries.Section(0.2, 0.5, 'rgba(0, 0, 0, 0)'),
                            steelseries.Section(0.5, 1, 'rgba(0, 0, 0, 0)'),
                            steelseries.Section(1, 1.5, 'rgba(0, 0, 0, 0)'),
                            steelseries.Section(1.5, 2, 'rgba(0, 0, 0, 0)'),
                            steelseries.Section(2, 2.5, 'rgba(0, 0, 0, 0)'),
                            steelseries.Section(2.5, 3, 'rgba(0, 0, 0, 0)'),
                            steelseries.Section(3, 4, 'rgba(0, 0, 0, 0)'),
                            steelseries.Section(4, 5, 'rgba(0, 0, 0, 0)'),
                            steelseries.Section(5, 20, 'rgba(0, 0, 0, 0)')];
            }
            return section;
        },
        ...
        createCloudBaseSections = function (metric) {
            var section;
            if (metric) {
                section = [ steelseries.Section(0, 150, 'rgba(204, 89, 30, 0.3)'),
                            steelseries.Section(150, 300, 'rgba(204, 89, 30, 0.2)'),
                            steelseries.Section(300, 750, 'rgba(204, 89, 30, 0.1)'),
                            steelseries.Section(750, 1000, 'rgba(15, 53, 90, 0)'),
                            steelseries.Section(1000, 1500, 'rgba(15, 53, 90, 0.2)'),
                            steelseries.Section(1500, 2500, 'rgba(15, 53, 90, 0.3)'),
                            steelseries.Section(2500, 5500, 'rgba(15, 53, 90, 0.4)')];
            } else {
                section = [ steelseries.Section(0, 500, 'rgba(204, 89, 30, 0.3)'),
                            steelseries.Section(500, 1000, 'rgba(204, 89, 30, 0.2)'),
                            steelseries.Section(1000, 2500, 'rgba(204, 89, 30, 0.1)'),
                            steelseries.Section(2500, 3500, 'rgba(15, 53, 90, 0)'),
                            steelseries.Section(3500, 5500, 'rgba(15, 53, 90, 0.1)'),
                            steelseries.Section(5500, 8500, 'rgba(15, 53, 90, 0.2)'),
                            steelseries.Section(8500, 18000, 'rgba(15, 53, 90, 0.3)')];
            }
            return section;
        },
